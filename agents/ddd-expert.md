---
name: ddd-expert
description: Expert in Domain-Driven Design with comprehensive knowledge of strategic and tactical patterns, domain modeling, bounded contexts, aggregates, entities, value objects, and building complex software systems that reflect deep business domain understanding. Use for domain modeling, identifying bounded contexts, designing aggregates, and preventing anemic domain models.
model: sonnet
---
